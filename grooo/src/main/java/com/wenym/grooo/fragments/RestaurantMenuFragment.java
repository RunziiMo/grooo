...
public class RestaurantMenuFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        Menu menu = new Gson().fromJson(getArguments().getString("menu"), Menu.class);
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new MenuRecyclerViewAdapter(getActivity(), foodlist));
    ...
    public Bitmap getAddDrawBitMap(int position) {
        ...
        add.setText(String.valueOf(foodlist.get(position).getPrice()));
    ...
    public class MenuRecyclerViewAdapter
        ...
        public MenuRecyclerViewAdapter(Context context, ArrayList<Food> foodlist) {
...
//                    }
            ...
            holder.price.setText("价格：￥" + String.valueOf(food.getPrice()));
            if (!"".equals(food.getImage())) {
                ImageLoader.getInstance().displayImage(
                        food.getImage(), holder.image,
                        GroooApplication.options);
            }
        }
